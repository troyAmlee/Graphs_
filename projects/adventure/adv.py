...
while(count < len(roomGraph)):
    random_room = random.randint(0, 3)
    direction = ["n", "s", "e", "w"]
    if(newMap.vertices[player.currentRoom.id][direction[random_room]] == "?"):
        print("Unexplored Path Found")
        count += 2
        # Do a depth first traversal in that direction
